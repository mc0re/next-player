...
Partial Class PolyhedronSideVisualizerWindow
    ...
    Private Sub InitializeComponent()
        ...
        Me.VisualizerControl = New GeometryVisualizers.PolyhedronSideVisualizerControl()
        Me.SuspendLayout()
        '
        'Host
        '
        ...
        Me.Name = "PolyhedronSideVisualizerWindow"
        Me.Text = "PolyhedronSide"
        Me.ResumeLayout(False)

    End Sub

    Friend WithEvents Host As Windows.Forms.Integration.ElementHost
    Friend VisualizerControl As PolyhedronSideVisualizerControl
End Class
