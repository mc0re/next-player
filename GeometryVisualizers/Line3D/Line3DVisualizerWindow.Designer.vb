...
Partial Class Line3DVisualizerWindow
    ...
    Private Sub InitializeComponent()
        ...
        Me.VisualizerControl = New GeometryVisualizers.Line3DVisualizerControl()
        Me.SuspendLayout()
        '
        'Host
        '
    ...
    Friend VisualizerControl As Line3DVisualizerControl
End Class
