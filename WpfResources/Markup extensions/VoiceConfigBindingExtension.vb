Imports Common
''' <summary>
''' Custom binding for voice-related configuration properties.
''' </summary>
Public Class VoiceConfigBindingExtension
    Inherits Binding
...
#Region " Binding functionality "
    ...
    Private Sub InitializeLink()
        ...
        Source = InterfaceMapper.GetImplementation(Of IVoiceConfiguration)(True)
...
#Region " Utility "
    ...
    Private Shared Function AdjustPath(path As String) As String
        ' Protection for design mode
        Dim config = InterfaceMapper.GetImplementation(Of IVoiceConfiguration)(True)
